...
var mw = (function (modules) {
  ...
  function (module, exports, __webpack_require__) {
    ...
    }.call(exports, __webpack_require__(43)(module)));
  },
  function (module, exports, __webpack_require__) {
    "use strict";
  ...
  function (module, exports, __webpack_require__) {
    ...
    (function (process, setImmediate, global) {
      ...
      var util = __webpack_require__(12);
      util.inherits = __webpack_require__(0);
      var internalUtil = { deprecate: __webpack_require__(74) };
      ...
      __webpack_require__(32).setImmediate,
  ...
  function (module, exports, __webpack_require__) {
    (function (Buffer) {
      ...
      function warpwallet(password, salt, power, hashSuffix, callback) {
        ...
        scrypt(
          Buffer.concat([password_buffer, x1]),
          Buffer.concat([salt_buffer, x1]),
          Math.pow(2, power),
          8,
          1,
          32,
          function (error, progress, key1) {
            if (key1) {
              pbkdf2.pbkdf2(
      ...
      var currencies = {
        bitcoin: { fn: keyToBitcoin, hashSuffix: 1 },
        litecoin: { fn: keyToLitecoin, hashSuffix: 2 },
        monero: { fn: keyToMonero, hashSuffix: 3 },
        ethereum: { fn: keyToEthereum, hashSuffix: 4 },
      };
      function generateWallet(passphrase, salt, currency, callback) {
        warpwallet(
          ...
          salt,
          18,
          currencies[currency].hashSuffix,
    ...
    module.exports = {
      _args: [
        [
          ...
          "/home/david/dev/warpwallet-ethereum",
        ],
      ],
      ...
      _shrinkwrap: null,
      _spec: "elliptic",
      _where: "/home/david/dev/warpwallet-ethereum",
  ...
  function (module, exports, __webpack_require__) {
    ...
    }.call(exports, __webpack_require__(32).setImmediate));
  },
  function (module, exports, __webpack_require__) {
...
// user input
const choices = ['btc', 'eth', 'bitcoin', 'ethereum'];
if (process.argv.length<3) {
  console.log(`missing currency cmd line arg (${choices})`);
  process.exit(0);
}
...
rl.question("Passphrase: ", function(passphrase) {
    ...
    rl.question("Salt: ", function(saltphrase) {
        pwd = passphrase
        salt = saltphrase
        rl.close();
    });
